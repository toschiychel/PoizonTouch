...
<div>
    <div class="preload-wrapper">
            ...
            <div class="container">
                <div class="tf-shop-control grid-3 align-items-center">
                    <div class="tf-control-filter">
                        <a href="#filterShop" data-bs-toggle="offcanvas" aria-controls="offcanvasLeft" class="tf-btn-filter"><span class="icon icon-filter"></span><span class="text">Фильтер</span></a>
                    </div>
                    ...
                    <!-- <div class="tf-control-sorting d-flex justify-content-end">
                        <div class="tf-dropdown-sort" data-bs-toggle="dropdown">
                            <div class="btn-select">
                                <span class="text-sort-value">Рекомендуемые</span>
                                <span class="icon icon-arrow-down"></span>
                            </div>
                            <div class="dropdown-menu">
                                <div class="select-item active">
                                    <span class="text-value-item">Рекомендуемые</span>
                                </div>
                                <div class="select-item" data-sort-value="price-low-high">
                                    <span class="text-value-item">Сначала дешевое</span>
                                </div>
                                <div class="select-item" data-sort-value="price-high-low">
                                    <span class="text-value-item">Сначала дорогое</span>
                                </div>
                                <div class="select-item" data-sort-value="a-z">
                                    <span class="text-value-item">По алфавиту, А-Я</span>
                                </div>
                                <div class="select-item" data-sort-value="z-a">
                                    <span class="text-value-item">По алфавиту, Я-А</span>
                                </div>
                            </div>
                        </div>
                    </div> -->
                ...
                <div class="wrapper-control-shop">
                    ...
                    <div class="tf-list-layout wrapper-shop" id="listLayout">
                        ...
                        <div class="card-product list-layout" data-availability="In stock" data-brand="Ecomus">
                            <div class="card-product-wrapper">
                                <a href="#" class="product-img">
                                    <img class="lazyload img-product" data-src="/src/assets/images/products/orange-1.jpg" src="@/assets/images/products/orange-1.jpg" alt="image-product">
                                    <img class="lazyload img-hover" data-src="/src/assets/images/products/white-1.jpg" src="@/assets/images/products/white-1.jpg" alt="image-product">
                                </a>
                            </div>
                            <div class="card-product-info">
                                ...
                                <ul class="list-color-product">
                                    <li class="list-color-item hover-tooltip color-swatch active">
                                        ...
                                        <img class="lazyload" data-src="/src/assets/images/products/orange-1.jpg" src="@/assets/images/products/orange-1.jpg" alt="image-product">
                                    </li>
                                    <li class="list-color-item color-swatch">
                                        <span class="tooltip">Black</span>
                                        <span class="swatch-value bg_dark"></span>
                                        <img class="lazyload" data-src="/src/assets/images/products/black-1.jpg" src="@/assets/images/products/black-1.jpg" alt="image-product">
                                    </li>
                                    <li class="list-color-item color-swatch">
                                        <span class="tooltip">White</span>
                                        <span class="swatch-value bg_white"></span>
                                        <img class="lazyload" data-src="/src/assets/images/products/white-1.jpg" src="@/assets/images/products/white-1.jpg" alt="image-product">
                                    </li>
                                </ul>
                                <div class="size-list">
                        ...
                        <div class="card-product list-layout" data-availability="In stock" data-brand="Ecomus">
                            <div class="card-product-wrapper">
                                <div class="product-img">
                                    <img class="lazyload img-product" data-src="/src/assets/images/products/brown.jpg" src="@/assets/images/products/brown.jpg" alt="image-product">
                                    <img class="lazyload img-hover" data-src="/src/assets/images/products/purple.jpg" src="@/assets/images/products/purple.jpg" alt="image-product">
                                </div>
                            ...
                            <div class="card-product-info">
                                ...
                                <ul class="list-color-product">
                                    <li class="list-color-item color-swatch active">
                                        ...
                                        <img class="lazyload" data-src="/src/assets/images/products/brown.jpg" src="@/assets/images/products/brown.jpg" alt="image-product">
                                    </li>
                                    <li class="list-color-item color-swatch">
                                        <span class="tooltip">Light Purple</span>
                                        <span class="swatch-value bg_purple"></span>
                                        <img class="lazyload" data-src="/src/assets/images/products/purple.jpg" src="@/assets/images/products/purple.jpg" alt="image-product">
                                    </li>
                                    <li class="list-color-item color-swatch">
                                        <span class="tooltip">Light Green</span>
                                        <span class="swatch-value bg_light-green"></span>
                                        <img class="lazyload" data-src="/src/assets/images/products/green.jpg" src="@/assets/images/products/green.jpg" alt="image-product">
                                    </li>
                                </ul>
                                <div class="size-list">
                                    <span class="size-item">S</span>
                        ...
                        <div class="card-product list-layout" data-availability="In stock" data-brand="Ecomus">
                            <div class="card-product-wrapper">
                                <div class="product-img">
                                    <img class="lazyload img-product" data-src="/src/assets/images/products/white-3.jpg" src="@/assets/images/products/white-3.jpg" alt="image-product">
                                    <img class="lazyload img-hover" data-src="/src/assets/images/products/white-4.jpg" src="@/assets/images/products/white-4.jpg" alt="image-product">
                                </div>
                            </div>
                            <div class="card-product-info">
                        ...
                        <div class="card-product list-layout" data-availability="In stock" data-brand="Ecomus">
                            <div class="card-product-wrapper">
                                <div class="product-img">
                                    <img class="lazyload img-product" data-src="/src/assets/images/products/white-2.jpg" src="@/assets/images/products/white-2.jpg" alt="image-product">
                                    <img class="lazyload img-hover" data-src="/src/assets/images/products/pink-1.jpg" src="@/assets/images/products/pink-1.jpg" alt="image-product">
                                </div>
                            </div>
                            <div class="card-product-info">
                                <a href="#" class="title link">Oversized Printed T-shirt</a>
                                ...
                                <ul class="list-color-product">
                                    <li class="list-color-item color-swatch active">
                                        <span class="tooltip">White</span>
                                        <span class="swatch-value bg_white"></span>
                                        <img class="lazyload" data-src="/src/assets/images/products/white-2.jpg" src="@/assets/images/products/white-2.jpg" alt="image-product">
                                    </li>
                                    <li class="list-color-item color-swatch">
                                        <span class="tooltip">Pink</span>
                                        <span class="swatch-value bg_purple"></span>
                                        <img class="lazyload" data-src="/src/assets/images/products/pink-1.jpg" src="@/assets/images/products/pink-1.jpg" alt="image-product">
                                    </li>
                                    <li class="list-color-item color-swatch">
                                        <span class="tooltip">Black</span>
                                        <span class="swatch-value bg_dark"></span>
                                        <img class="lazyload" data-src="/src/assets/images/products/black-2.jpg" src="@/assets/images/products/black-2.jpg" alt="image-product">
                                    </li>
                                </ul>
                                <div class="size-list">
                                    <span class="size-item">S</span>
                        ...
                        <div class="card-product list-layout" data-availability="In stock" data-brand="Ecomus">
                            <div class="card-product-wrapper">
                                <div class="product-img">
                                    <img class="lazyload img-product" data-src="/src/assets/images/products/brown-2.jpg" src="@/assets/images/products/brown-2.jpg" alt="image-product">
                                    <img class="lazyload img-hover" data-src="/src/assets/images/products/brown-3.jpg" src="@/assets/images/products/brown-3.jpg" alt="image-product">
                                </div>
                            </div>
                            <div class="card-product-info">
                                ...
                                <ul class="list-color-product">
                                    <li class="list-color-item color-swatch active">
                                        <span class="tooltip">Brown</span>
                                        <span class="swatch-value bg_brown"></span>
                                        <img class="lazyload" data-src="/src/assets/images/products/brown-2.jpg" src="@/assets/images/products/brown-2.jpg" alt="image-product">
                                    </li>
                                    <li class="list-color-item color-swatch">
                                        <span class="tooltip">White</span>
                                        <span class="swatch-value bg_white"></span>
                                        <img class="lazyload" data-src="/src/assets/images/products/white-5.jpg" src="@/assets/images/products/white-5.jpg" alt="image-product">
                                    </li>
                                </ul>
                                <div class="size-list">
                                    <span class="size-item">S</span>
                        ...
                        <div class="card-product list-layout" data-availability="In stock" data-brand="M&H">
                            <div class="card-product-wrapper">
                                <div class="product-img">
                                    <img class="lazyload img-product" data-src="/src/assets/images/products/light-green-1.jpg" src="@/assets/images/products/light-green-1.jpg" alt="image-product">
                                    <img class="lazyload img-hover" data-src="/src/assets/images/products/light-green-2.jpg" src="@/assets/images/products/light-green-2.jpg" alt="image-product">
                                </div>
                            </div>
                            <div class="card-product-info">
                                ...
                                <ul class="list-color-product">
                                    <li class="list-color-item color-swatch active">
                                        <span class="tooltip">Light Green</span>
                                        <span class="swatch-value bg_light-green"></span>
                                        <img class="lazyload" data-src="/src/assets/images/products/light-green-1.jpg" src="@/assets/images/products/light-green-1.jpg" alt="image-product">
                                    </li>
                                    <li class="list-color-item color-swatch">
                                        <span class="tooltip">Black</span>
                                        <span class="swatch-value bg_dark"></span>
                                        <img class="lazyload" data-src="/src/assets/images/products/black-3.jpg" src="@/assets/images/products/black-3.jpg" alt="image-product">
                                    </li>
                                    <li class="list-color-item color-swatch">
                                        <span class="tooltip">Blue</span>
                                        <span class="swatch-value bg_blue-2"></span>
                                        <img class="lazyload" data-src="/src/assets/images/products/blue.jpg" src="@/assets/images/products/blue.jpg" alt="image-product">
                                    </li>
                                    <li class="list-color-item color-swatch">
                                        <span class="tooltip">Dark Blue</span>
                                        <span class="swatch-value bg_dark-blue"></span>
                                        <img class="lazyload" data-src="/src/assets/images/products/dark-blue.jpg" src="@/assets/images/products/dark-blue.jpg" alt="image-product">
                                    </li>
                                    <li class="list-color-item color-swatch">
                                        <span class="tooltip">White</span>
                                        <span class="swatch-value bg_white"></span>
                                        <img class="lazyload" data-src="/src/assets/images/products/white-6.jpg" src="@/assets/images/products/white-6.jpg" alt="image-product">
                                    </li>
                                    <li class="list-color-item color-swatch">
                                        <span class="tooltip">Light Grey</span>
                                        <span class="swatch-value bg_light-grey"></span>
                                        <img class="lazyload" data-src="/src/assets/images/products/light-grey.jpg" src="@/assets/images/products/light-grey.jpg" alt="image-product">
                                    </li>
                                </ul>
                                <div class="list-product-btn">
                                    <a href="#quick_add" data-bs-toggle="modal" class="box-icon quick-add style-3"><span class="icon icon-bag"></span><span class="tooltip">Quick add</span></a>
                        ...
                        <div class="card-product list-layout" data-availability="Out of stock" data-brand="M&H">
                            <div class="card-product-wrapper">
                                <div class="product-img">
                                    <img class="lazyload img-product" data-src="/src/assets/images/products/black-4.jpg" src="@/assets/images/products/black-4.jpg" alt="image-product">
                                    <img class="lazyload img-hover" data-src="/src/assets/images/products/black-5.jpg" src="@/assets/images/products/black-5.jpg" alt="image-product">
                                </div>
                            </div>
                            <div class="card-product-info">
                                ...
                                <ul class="list-color-product">
                                    <li class="list-color-item color-swatch active">
                                        <span class="tooltip">Black</span>
                                        <span class="swatch-value bg_dark"></span>
                                        <img class="lazyload" data-src="/src/assets/images/products/black-4.jpg" src="@/assets/images/products/black-4.jpg" alt="image-product">
                                    </li>
                                    <li class="list-color-item color-swatch">
                                        <span class="tooltip">Dark Blue</span>
                                        <span class="swatch-value bg_dark-blue"></span>
                                        <img class="lazyload" data-src="/src/assets/images/products/dark-blue-2.jpg" src="@/assets/images/products/dark-blue-2.jpg" alt="image-product">
                                    </li>
                                    <li class="list-color-item color-swatch">
                                        <span class="tooltip">Beige</span>
                                        <span class="swatch-value bg_beige"></span>
                                        <img class="lazyload" data-src="/src/assets/images/products/beige.jpg" src="@/assets/images/products/beige.jpg" alt="image-product">
                                    </li>
                                    <li class="list-color-item color-swatch">
                                        <span class="tooltip">Light Blue</span>
                                        <span class="swatch-value bg_light-blue"></span>
                                        <img class="lazyload" data-src="/src/assets/images/products/light-blue.jpg" src="@/assets/images/products/light-blue.jpg" alt="image-product">
                                    </li>
                                    <li class="list-color-item color-swatch">
                                        <span class="tooltip">White</span>
                                        <span class="swatch-value bg_white"></span>
                                        <img class="lazyload" data-src="/src/assets/images/products/white-7.jpg" src="@/assets/images/products/white-7.jpg" alt="image-product">
                                    </li>
                                </ul>
                                <div class="size-list">
                                    <span class="size-item">S</span>
                        ...
                        <div class="card-product list-layout" data-availability="Out of stock" data-brand="M&H">
                            <div class="card-product-wrapper">
                                <div class="product-img">
                                    <img class="lazyload img-product" data-src="/src/assets/images/products/white-8.jpg" src="@/assets/images/products/white-8.jpg" alt="image-product">
                                    <img class="lazyload img-hover" data-src="/src/assets/images/products/black-6.jpg" src="@/assets/images/products/black-6.jpg" alt="image-product">
                                </div>
                            </div>
                            <div class="card-product-info">
                                ...
                                <ul class="list-color-product">
                                    <li class="list-color-item color-swatch active">
                                        <span class="tooltip">White</span>
                                        <span class="swatch-value bg_white"></span>
                                        <img class="lazyload" data-src="/src/assets/images/products/white-8.jpg" src="@/assets/images/products/white-8.jpg" alt="image-product">
                                    </li>
                                    <li class="list-color-item color-swatch">
                                        <span class="tooltip">Black</span>
                                        <span class="swatch-value bg_dark"></span>
                                        <img class="lazyload" data-src="/src/assets/images/products/black-7.jpg" src="@/assets/images/products/black-7.jpg" alt="image-product">
                                    </li>
                                    <li class="list-color-item color-swatch">
                                        <span class="tooltip">Blue</span>
                                        <span class="swatch-value bg_blue-2"></span>
                                        <img class="lazyload" data-src="/src/assets/images/products/blue-2.jpg" src="@/assets/images/products/blue-2.jpg" alt="image-product">
                                    </li>
                                </ul>
                                <div class="size-list">
                                    <span class="size-item">S</span>
                    ...
                    <div v-if="products && products.length == 0" class="page-404-wrap">
                        <div class="container">
                            <div class="row">
                                <div class="col-12">
                                    <div class="image">
                                        <img style="width: 20%;" src="@/assets/images/item/404.svg" alt="">
                                    </div>
                                    <div class="title">
                                        Уупс...Не нашли товаров
                                    </div>
                                    <p>Извините за неудобства. Мы постоянно работаем над пополнением товаров.</p>
                                    <a @click.prevent="resetFilters" href="#" class="tf-btn btn-sm radius-3 btn-fill btn-icon animate-hover-btn">Сбросить фильтр</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="tf-grid-layout wrapper-shop tf-col-4" id="gridLayout">
                        ...
                        <template v-for="product in products">
                            <div class="card-product grid" data-availability="In stock" data-brand="Ecomus">
                                <div class="card-product-wrapper">
                                    <a @click.prevent="selectProduct(product)" href="#quick_view" data-bs-toggle="modal" class="product-img">
                                    ...
                                    <div class="list-product-btn absolute-2">
                                        <a @click.prevent="addToCard(product)" href="#" class="box-icon bg_white quick-add tf-btn-loading">
                                        ...
                                        <router-link :to="`/products/${product.id}`" class="box-icon bg_white quickview tf-btn-loading">
                                            <span class="icon icon-view"></span>
                                            <span class="tooltip">Открыть товар</span>
                                        </router-link>
                                        <!-- <a @click.prevent="selectProduct(product)" href="#quick_view" data-bs-toggle="modal" class="box-icon bg_white quickview tf-btn-loading">
                                            <span class="icon icon-view"></span>
                                ...
                                <div class="card-product-info">
                                    <a @click.prevent="selectProduct(product)" href="#quick_view" data-bs-toggle="modal" class="title link">{{ product.title }}</a>
                        ...
                        <!-- pagination -->
                        <ul class="wg-pagination tf-pagination-list" v-if="pagination.last_page > 1">
                            <li v-if="pagination.current_page != 1">
                                <a @click.prevent="getProducts(pagination.current_page - 1)" href="#" class="pagination-link animate-hover-btn">
                                    <span class="icon icon-arrow-left"></span>
                                </a>
                            </li>
                            <li v-if="pagination.current_page == 1">
                                <a @click.prevent="" href="#" class="pagination-link animate-hover-btn">
                                    <span class="icon icon-arrow-left"></span>
                                </a>
                            </li>
                            <template v-for="link in pagination.links">
                                ...
                                ">
                                    <li :class="link.active ? ' active' : ''">
                                        <a @click.prevent="getProducts(link.label)" href="#" class="pagination-link">{{ link.label }}</a>
                                    </li>
                                </template>
                                <template v-if="Number(link.label) 
                                ...
                                || (pagination.current_page - link.label == -2 &&
                                    (pagination.last_page - link.label == 2 || pagination.current_page == 2))
                                ">
                                    <li>
                                        <a @click.prevent="" href="#" class="pagination-link">-</a>
                                    </li>
                                </template>
                            </template>
        ...
        <!-- /Section Product -->
        <!-- Filter -->
        <div v-if="filter.price" class="offcanvas offcanvas-start canvas-filter" id="filterShop">
                ...
                <div class="canvas-body">
                    <form action="#" id="facet-filter-form" class="facet-filter-form">
                        <div class="widget-facet">
                            <div class="facet-title collapsed" data-bs-target="#availability" data-bs-toggle="collapse" aria-expanded="true" aria-controls="availability">
                                <span>Категория</span>
                                <span class="icon icon-arrow-up"></span>
                            </div>
                            <div id="availability" class="collapse show">
                                <ul class="tf-filter-group current-scrollbar mb_36">
                                    <li v-for="category in filter.categories" class="list-item d-flex gap-12 align-items-center">
                                        <input v-model="categories" :value="category.id" type="checkbox" class="tf-check">
                                        <label for="inStock" class="label"><span>{{ category.title }}</span>&nbsp;</label>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="widget-facet">
                            ...
                            <div id="price" class="collapse show">
                                <div class="widget-price filter-price">
                                    <div class="price-val-range" id="price-value-range" :data-min="filter.price.min" :data-max="filter.price.max"></div>
                                    <div class="box-title-price">
                                        <span class="title-price">Цена :</span>
                                        <div class="caption-price">
                                            <div ref="priceMinValue" class="price-val" id="price-min-value" data-currency="₽">{{ filter.price.min }}</div>
                                            <span>-</span>
                                            <div ref="priceMaxValue" class="price-val" id="price-max-value" data-currency="₽">{{ filter.price.max }}</div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="widget-facet">
                            ...
                            <div id="brand" class="collapse show">
                                <ul class="tf-filter-group current-scrollbar mb_36">
                                    <li v-for="tag in filter.tags" class="list-item d-flex gap-12 align-items-center">
                                        <input v-model="tags" :value="tag.id" type="checkbox" name="brand" class="tf-check">
                                        <label for="Ecomus" class="label"><span>{{ tag.title }}</span>&nbsp;</label>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="widget-facet">
                            ...
                            <div id="color" class="collapse show">
                                <ul class="tf-filter-group filter-color current-scrollbar mb_36">
                                    <li v-for="color in filter.colors" class="list-item d-flex gap-12 align-items-center">
                                        <input v-model="colors" :value="color.id" type="checkbox" name="color" class="tf-check-color swatch-value" :style="`background-color: ${color.hex} ; border: 1px solid black;` ">
                                        <label for="Beige" class="label"><span>{{ color.title }}</span>&nbsp;</label>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="tf-control-filter tf-control-filter-2">
                            <a @click.prevent="getProductList()" href="#" data-bs-toggle="offcanvas" aria-controls="offcanvasLeft" class="tf-btn-filter"><span class="icon icon-filter"></span><span class="text">Применить</span></a>
                        </div>
                    </form>
                </div>
            </div>
                            ...
                            <div class="tf-product-media-wrap">
                                <div dir="ltr" class="swiper tf-single-slide">
                                    <div class="swiper-wrapper">
                                        ...
                                        <div v-for="image in selectedProduct.images" class="swiper-slide">
                                            <div class="item">
                            ...
                            <div class="tf-product-info-wrap position-relative">
                                <div class="tf-product-info-list">
                                    <div class="tf-product-info-title">
                                        <h5 class="link">{{ selectedProduct.title }}</h5>
                                    </div>
                                    <div class="tf-product-info-badges">
                                        <div class="badges text-uppercase">Топ продаж</div>
                                        <div v-if="selectedProduct.count < 50" class="product-status-content">
                                            <i class="icon-lightning"></i>
                                            <p class="fw-6">Успей купить! Осталось {{ selectedProduct.count }} штук!</p>
                                        </div>
                                    </div>
                                    <div class="tf-product-info-price">
                                    ...
                                    <div class="tf-product-info-variant-picker">
                                        <div class="variant-picker-item">
                                            <div class="variant-picker-label">
                                                Цвет: <span class="fw-6 variant-picker-label-value"></span>
                                            </div>
                                            <div class="variant-picker-values">
                                                <template v-for="color in selectedProduct.colors">
                                                    <input id="values-orange-1" type="checkbox" name="color-1" disabled checked>
                                    ...
                                    <div class="tf-product-info-quantity">
                                        ...
                                        <div class="wg-quantity">
                                            <span class="btn-quantity minus-btn">-</span>
                                            <input id="product-quantity" type="text" name="number" value="1">
                                            <span class="btn-quantity plus-btn">+</span>
                                        </div>
                                    </div>
                                    <div class="tf-product-info-buy-button">
                                        <form class="">
                                            <a @click.prevent="addToCard(selectedProduct)" href="javascript:void(0);" class="tf-btn btn-fill justify-content-center fw-6 fs-16 flex-grow-1 animate-hover-btn btn-add-to-cart"><span>Добавить в корзину -&nbsp;</span><span class="tf-qty-price">{{ selectedProduct.price }}₽</span></a>
                                            ...
                                            <!-- <div class="w-100">
                                                <a href="#" class="btns-full">Купить в один клик <img src="@/assets/images/payments/paypal.png" alt=""></a>
                                            </div> -->
                                        </form>
                                    </div>
                                    <!-- <div>
                                        <router-link :to="`/products/${selectedProduct.id}`" class="tf-btn fw-6 btn-line">Открыть страницу продукта<i class="icon icon-arrow1-top-left"></i></router-link>
                                    </div> -->
                                </div>
                            </div>
                        </div>
...
export default {
    ...
    beforeUnmount() {
        ...
        const offcanvasEl = document.getElementById('filterShop');
        if (offcanvasEl) {
    ...
    methods: {
        getProducts(page = 1) { // доделать price
        ...
        getProductList(page = 1) {
            const priceMinValue = this.$refs.priceMinValue.innerText;
            const priceMaxValue = this.$refs.priceMaxValue.innerText;
            this.prices = []
            this.prices.push({
                min: priceMinValue,
                max: priceMaxValue
...
.tf-control-filter-2 {
    ...
    /* Фиксируем элемент */
    bottom: 0;
    /* Прикрепляем к нижней части окна */
    background-color: white;
    /* Задаем фон, чтобы элемент был видим */
    padding-bottom: 10px;
    /* Добавляем отступы для удобства */
    z-index: 1000;
    /* Устанавливаем высокий индекс, чтобы элемент был поверх других */
}
</style>
