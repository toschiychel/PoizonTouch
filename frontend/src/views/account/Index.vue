                ...
                <div class="row">
                    <div class="col-lg-3">
                        <div class="wrap-sidebar-account">
                            <ul class="my-account-nav">
                                <li><span class="my-account-nav-item active">Главная</span></li>
                                <li>
                                    <router-link to="/account/orders" class="my-account-nav-item">Заказы</router-link>
                                </li>
                    ...
                    <div class="col-lg-9">
                        <div class="my-account-content account-dashboard">
                            <div class="mb_60">
                                <h5 v-if="user" class="fw-5 mb_20">Здравствуйте, {{ user.name }}</h5>
                                <p>
                                    В вашем аккаунте вы можете просмотреть свои <router-link :to="{ name: 'account.order'}" class="text_primary">недавние заказы</router-link>, управлять <router-link :to="{ name: 'account.edit'}" class="text_primary">адресами доставки и контактной информацией</router-link>.
                                </p>
                            </div>
                        </div>
                    </div>
