            ...
            <div class="container">
                <div class="form-register-wrap">
                    <div class="flat-title align-items-start gap-0 mb_30 px-0">
                        <h5 class="mb_18">Вход в аккаунт</h5>
                    ...
                    <div>
                        <form class="" id="register-form" action="#" method="post" accept-charset="utf-8" data-mailchimp="true">
                            ...
                            <div class="mb_20">
                                <button @click.prevent="login()" type="submit" class="tf-btn w-100 radius-3 btn-fill animate-hover-btn justify-content-center">Войти</button>
                            </div>
                            <div class="text-center">
                                <router-link :to="{ name: 'account.register'}" class="tf-btn btn-line">Ещё нет аккаунта? Зарегистрироваться<i class="icon icon-arrow1-top-left"></i></router-link>
                            </div>
                        </form>
                    </div>
                </div>
